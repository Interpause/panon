...
The plasmoid will create a venv and install Python dependencies automatically on first run. If your default Python is 3.12, manually creating the venv might be necessary.
